  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      <SEO 
        ...
        description="Evento geek completo em Nova Friburgo: cosplay, k-pop, animekê, videogames, retro games e muito mais! Garanta seu ingresso para o Friburgo Geek 2026."
        canonical="/"
