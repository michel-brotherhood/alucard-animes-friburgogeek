...
const schedule = [
  ...
  { time: "14:00", event: "Campeonato K-POP Generations", location: "STAGE Principal" },
  { time: "14:30", event: "Cine Anime", location: "Sala de Cinema" },
  { time: "15:00", event: "Concurso de Cosplay", location: "STAGE Principal" },
  { time: "15:30", event: "Beat Saber VR", location: "Arena VR" },
  { time: "16:00", event: "Animeke Livre", location: "STAGE Principal" },
  { time: "16:30", event: "Board Games & Wood Games", location: "Área Interativa" },
  { time: "17:00", event: "Finais dos Campeonatos", location: "STAGE Principal" },
  { time: "17:30", event: "Premiações e Sorteios", location: "STAGE Principal" },
